...
const testimonialData: Testimonial[] = [
  {
    ...
    quote:'Webシステムの立ち上げに際し、こちらの会社にご相談させていただきました。Beekleのチームに対して感じたのは、ひとえに「完遂能力とコミットメントの高さ」です。要件定義の段階から丁寧にヒアリングを行っていただき、私たちの想いや業務内容を的確に汲み取って設計へ反映していただけた点が、非常に印象的でした。これまで、他の会社に依頼した際には、当初のヒアリング内容と異なる形で費用にズレが生じたり、開発自体が頓挫したりする経験もありました。しかし、Beekleに出会い、代表の強いリーダーシップとチームの高い推進力により、ユーザーにとって使いやすい画面設計を実現することができました。専門用語に不慣れな私たちの意見も上手に汲み取ってくださった点や、複数のパートナー企業との連携を含めたスムーズで信頼感のある進行管理も、高く評価しています。今後もWebやシステム関連のプロジェクトがあれば、ぜひまたお願いしたいと考えています。',
    rating:5
  },
  {
    id: 3,
