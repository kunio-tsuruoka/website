...
const MAPPING: Record<string, CategoryCta> = {
  // project-management は読者がエンジニアに寄っており買い手クエリではない（ユーザー判断 2026-09-12）。
  // 主動線は PM on Rails ウェイトリスト、副動線は協業相談。本文側は {{PM_ON_RAILS_ASSURANCE}} で揃える。
  'project-management': buildCta(
