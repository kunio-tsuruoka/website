...
export const industryServices: ServiceDetail[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    seoDescription:
      '「VPNがつながらない」「アカウント申請はどうやる」と情シスに集まる問い合わせを、社内文書とルールを参照するAIが一次対応し、判断が要るものだけ人へ渡す仕組みを作ります。まず問い合わせの多い一領域から、4〜6週間・150〜300万円程度。',
    description:
    ...
    additionalSections: [
      ...
      pricingSection(
        '情シスへの定型問い合わせの一部をAI一次対応にする（4〜6週間、150〜300万円程度）',
