export const aiServicePageConfig = {
  ...
  'requirements-definition-support': {
    ...
    heroLead:
      '会話を要求・受入条件・実装タスクまでつなぐ自社PM基盤がある。だから要件定義が長引かず、AIが迷わず実装できる。',
    primaryOutcome:
    ...
    rtb: {
      ...
      note: {
        ...
        description:
          '要求、要件、ユーザーストーリー、受入条件、実装タスク、確認結果を複製せず関係でつなぐ基盤です。Beekleの開発現場で実際に使っています。相談のあと、会話がどの形で残るかを一緒に見られます。',
        href: 'https://pmonrails.com',
        hrefLabel: 'PM on Railsの公開サイトを見る',
      },
    },
  },
} as const;
