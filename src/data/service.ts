...
export const services: ServiceDetail[] = [
  ...
  },
  {
    ...
    title: '生成AI受託開発',
    description:
      '社内資料検索、問い合わせ対応、書類処理、定型業務の自動化まで。生成AIを業務に組み込む開発サービス。',
    longDescription:
      '資料探し、問い合わせ対応、書類の転記、複数システムをまたぐ確認作業など、手間がかかっている業務に生成AIを組み込む受託開発を提供します。どの業務から始めるかの整理、動く試作品での確認、社内で使える状態への改善、運用まで一気通貫でサポートします。',
    seoTitle: '生成AI受託開発｜社内資料検索・問い合わせ対応・書類処理をAIで改善 | Beekle',
    seoDescription:
      '生成AI受託開発の専門チームが、社内資料検索、問い合わせ対応、書類処理、定型業務の自動化まで対応。「どの業務から始めればよいか分からない」「試しただけで終わらせたくない」という悩みに、動く試作品で答えます。初期費用0円のゼロスタートで無料相談から開始可能。',
    painPoints: [
      {
