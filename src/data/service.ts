...
export const services: ServiceDetail[] = [
 {
   ...
   longDescription: "アプリケーション・システム開発業務のみではなく、そもそもの解決したい課題は何なのか？といった要件定義やサービスデザインから始まり、サービスを継続的に発展させる運用フェーズまで幅広くサポートする事が可能です。マーケティングに精通しているメンバーも在籍しており、マーケティングの支援とアプリケーションの制作セットでお客様を支援することが可能です。",
   painPoints: [
     {
       title: "開発リソース不足",
       description: "社内のエンジニアリソースが限られており、新規開発や既存システムの改修に時間がかかっている"
     },
     {
       title: "保守性・拡張性の課題",
   ...
   faq: [
     {
       ...
       answer: "規模にもよりますが、小規模なシステムで3-4ヶ月、中規模で6-8ヶ月が目安です。段階的なリリースも可能です。"
     },
     {
       question: "既存システムの改修は可能ですか？",
       answer: "可能です。現状の課題を詳細に分析し、段階的な改善提案と実装を行います。必要に応じて、全面的なリプレイスも検討します。"
     },
     {
       question: "保守・運用体制はどうなっていますか？",
       answer: "24時間365日の監視体制を整えており、障害発生時の即時対応が可能です。また、定期的な保守点検とアップデートも含まれます。"
     }
   ]
 },
 {
   id: "prototype-poc",
   title: "プロトタイプ・POC作成",
   description: "プロダクトやサービスのアイデアをさまざまな形で具体化し、ニーズを検証。より良いアイデアへと昇華させます。",
   longDescription: "当社は、プロダクトやサービスのアイデアを様々な方法で実現可能な形に具体化し、ニーズがあるかを検証し、より効果的なアイデアに昇華することで、ユーザーにとって価値の高いプロダクトやサービスを作り上げることを目指しています。",
   painPoints: [
     {
       title: "市場投入の不確実性",
   ...
   faq: [
     {
       ...
       answer: "基本的な機能検証であれば3-4週間、より詳細な検証が必要な場合は2-3ヶ月程度を目安としています。完全にデザインは生成に任せて、プロトタイプを作る場合です。要件にもよるので詳しくはお問い合わせに"
     },
     {
       question: "プロトタイプ開発後、本開発にスムーズに移行できますか？",
       answer: "はい。プロトタイプ開発時から本開発を見据えた技術選定を行い、スムーズな移行をサポートします。求められるビジネス要件・保守性を考えて技術選定をいたします"
     },
     {
       question: "ユーザーテストはどのように行われますか？",
       answer: "対象となるユーザー層を選定し、実際の利用シーンを想定したタスクベースのテストを実施します。必要に応じてアンケートやインタビューも組み合わせます。"
     }
   ]
 },
 {
   ...
   longDescription: "グローバル展開を目指す企業様向けに、海外市場での成功を支援するための包括的なサービスを提供します。現地のユーザー習慣や文化的な違いを考慮した、効果的なデジタルプレゼンスの構築をサポートします。",
   painPoints: [
     {
       title: "言語・文化の壁",
    ...
    faq: [
      {
        ...
        answer: "英語、中国語、韓国語を中心に、東南アジア言語まで幅広く対応可能です。必要に応じて他言語にも対応いたします。"
      },
      {
        question: "海外向けマーケティングの効果測定はどうしていますか？",
        answer: "Google AnalyticsやSNS分析ツールを使用し、地域別のユーザー行動や集客効果を測定。月次でレポーティングを行います。"
      },
      {
        question: "越境ECの導入期間はどのくらいですか？",
        answer: "基本的な機能であれば3-4ヶ月、フル機能の場合は6-8ヶ月程度です。段階的なローンチも可能です。"
      }
    ]
  },
  {
    ...
    longDescription: "ChatGPTやStable Diffusionなどの生成AIを活用したサービス開発を支援します。ビジネスの課題に合わせて、最適なAIモデルの選定から、カスタマイズ、システム統合まで、包括的なサポートを提供します。",
    painPoints: [
      {
        title: "技術選定の難しさ",
    ...
    faq: [
      {
        ...
        answer: "OpenAI GPT、Anthropic Claude、Stable Diffusion、Midjourney等、主要な生成AIモデルに対応しています。用途に応じて最適なモデルを選定・提案させていただきます。"
      },
      {
        question: "APIコストはどのように最適化されますか？",
        answer: "キャッシュ戦略の導入や効率的なプロンプト設計により、APIコストを最小限に抑えます。また、使用量の予測とモニタリングにより、コストの透明性を確保します。"
      },
      {
        question: "生成結果の品質はどのように担保されますか？",
        answer: "入念なプロンプト設計とバリデーション処理の実装により、高品質な生成結果を確保します。また、人間によるレビューと組み合わせたハイブリッドな運用体制も構築可能です。"
      }
    ]
  },
  {
    ...
    longDescription: "Bubble、Webflow、Airtableなどのノーコードツールを活用し、最小限のコストと時間で機能するプロトタイプを開発。アイデアの検証からMVP開発まで、スピーディーな開発を実現します。",
    painPoints: [
      {
        title: "開発スピードの課題",
    ...
    faq: [
      {
        ...
        answer: "Bubble、Webflow、Airtable、Zapier等、実績のある主要ツールを用途に応じて使用します。要件に応じて最適なツールを選定・提案させていただきます。"
      },
      {
        question: "本開発への移行は可能ですか？",
        answer: "はい、POCの結果を基に、必要に応じて従来の開発手法への移行も可能です。スケーラビリティやパフォーマンスの要件を考慮し、最適な移行計画を立案します。"
      },
      {
        question: "開発期間はどのくらいですか？",
        answer: "基本的な機能であれば1ヶ月、より複雑な機能でも2-3ヶ月程度で開発可能です。要件の複雑さにより変動しますので、詳細はご相談ください。"
      }
    ]
  }
 ];