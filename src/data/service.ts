...
export const services: ServiceDetail[] = [
  {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        solution:
          '決済・マッチング・チャットの要件を切り分けたうえで、外部決済は差し替え可能なドライバとして設計。課金率を左右する導線を特定してサーバーコンポーネント中心に構成し、流入増に自動で追従するインフラをコードで管理しました。さらにBigQueryを中心に顧客データ基盤（CDP）を構築し、購買データを分析して優良顧客層を特定。LPと課金導線の改善に反映しています。',
        whyUs:
        ...
        techStack: [
          ...
          'データ基盤・分析: BigQuery を中心とした複数ソース統合CDP（アプリDB・GA4等）、Databricks on AWS、RFM・コホート・相関・因果分析',
        ],
      },
    ],
    features: [
  ...
  },
  {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        solution:
          'BigQueryを中心に顧客データ基盤（CDP）を構築してデータを統合し、購買データを分析して優良顧客層を特定。LPと課金導線の改善に反映しました。',
        whyUs:
