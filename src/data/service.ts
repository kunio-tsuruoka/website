...
export const services: ServiceDetail[] = [
  ...
  },
  {
    ...
    seoDescription:
      '「何を作るべきか」が曖昧な段階から相談できるシステム開発。Beekleは要件定義のヒアリングから入り、動く確認材料で要件を画面で確かめながら固めます。発注前に使える無料の要件整理ツール4種も公開しています。',
    description:
      '要件がまだ固まっていない段階から相談できるシステム開発です。ヒアリングで課題を整理し、動くプロトタイプで要件を確かめながら、発注前のリスクを抑えて開発を進めます。',
    longDescription:
      'システム開発の発注でつまずく最大の原因は、「何を作るべきか（要件）」が固まらないまま見積もりや契約に進んでしまうことです。Beekleは発注者目線のシステム開発会社として、要件定義のヒアリングから入ります。指示された内容をそのまま実装するのではなく、開発依頼の背景や事業課題を深く聞き取り、本当に必要な機能を一緒に定義します。さらに動く確認材料で要件を文章ではなく画面で確かめながら固められるため、認識のズレや手戻りを着手前に減らせます。要件定義から設計・デザイン・開発・運用までを小さなチームで一貫して担当します。',
    painPoints: [
      {
