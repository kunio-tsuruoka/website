  ...
  },
  {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        challenge:
          '情報システム部門2名で社内のIT問い合わせに対応しており、パスワードリセットや接続設定といった定型質問に追われて、本来やるべきセキュリティ対策やインフラ改善に手が回らない状態が続いていました。',
        solution:
          'Slack上でIT関連のFAQと社内マニュアルから即答し、答えられない質問だけを担当者にメンションで引き継ぐボットを構築しました。',
        whyUs:
      ...
      },
      {
        ...
        challenge:
          '製品仕様や施工方法の問い合わせが多く、カタログの種類も多いため、担当者がすべてを把握しきれず回答に時間がかかっていました。営業時間外の問い合わせは翌日以降に持ち越されていました。',
        solution:
