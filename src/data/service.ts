  ...
  },
  {
    ...
    solutions: [
      {
        ...
        results: ['費用感を早く把握', '処理時間を短縮', '本番利用の判断を早める'],
      },
      {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        challenge:
          '会食・接待・記念日など、利用シーンに合う飲食店提案が営業担当の経験に依存していた。店舗情報、会員情報、希望条件をもとに、推薦理由まで説明できる体験を短期間で検証したかった。',
        solution:
          'React + Honoで、会員属性・利用目的・希望条件をもとに候補店舗を提示するAI推薦UIを設計。飲食店一覧・詳細、推薦ダイアログ、会員管理、営業担当ダッシュボードまでつなげ、提案業務のプロトタイプとして構築した。',
        results: [
          '利用シーンに合う提案品質を検証',
          '推薦理由の提示で営業提案を支援',
          '会員管理から推薦まで業務導線を試作',
      ...
      },
      {
        ...
        challenge:
          '音声メッセージや1対1通話で、言語が異なるユーザー同士が自然に会話できる体験を検証したかった。単なる翻訳機能ではなく、意味の確認や語彙として残す学習導線まで含める必要があった。',
        solution:
          'Flutter + Cloudflare Workersで、音声の文字起こし・翻訳、リアルタイム通話、選択テキストのAI解説、語彙帳までを含むMVP基盤を構築した。OpenAI連携をモバイル体験の中に組み込み、継続利用しやすいAIプロダクトとして設計した。',
        results: [
          '言語の壁を下げる会話体験を検証',
          '音声・通話・AI解説を統合',
          '語彙学習まで含めた継続利用導線を構築',
      ...
      },
      {
        ...
        challenge:
          '多拠点から集まるレシート画像を見ながら、売上金額や件数を手入力する業務に時間がかかっていた。帳票形式や表記ゆれもあり、固定ルールだけでは実務に合わせにくかった。',
        solution:
          'Laravel + Inertia + Reactで、レシート画像アップロード、生成AI OCR、構造化データ化、確認画面までを備えたPoCを構築した。画像からのテキスト抽出と業務項目へのJSON化を分けて処理し、人が確認しやすい形にした。',
        results: [
          '手入力業務の削減可能性を検証',
          '売上・件数・日付を集計しやすく構造化',
          '人が確認しやすいレビュー導線を構築',
      ...
      },
      {
        ...
        solution:
          '紙・PDFを読み取り、取引先ごとに形式が違っても必要な項目を取り出せるシステムを構築。読み取りに迷う箇所だけ人が確認できる画面も用意した。',
        results: [
          '転記工数の削減',
          '異なるフォーマットの帳票にも一貫対応',
          '人間レビューと組み合わせた品質担保',
    ...
    features: [
      ...
      },
      {
        ...
        description:
          '社内システムや管理画面にAI機能を組み込み、担当者が普段の業務の中で使える形にします。',
      },
      {
        title: '社内資料から答えるAI検索',
        description:
          '規程、FAQ、マニュアル、過去対応を横断し、回答と一緒に根拠箇所を提示する仕組みを作ります。',
      },
      {
        title: 'AIエージェント開発',
        description:
          '複数の社内ツールをまたぐ調査、入力、通知などを、人の確認を挟みながら前へ進めるAIを設計・実装します。',
      },
      {
        title: '回答ルールと改善の仕組みづくり',
        description:
          '回答例、NG例、人が確認する条件を整え、導入後も品質を改善できる仕組みを作ります。',
      },
      {
        title: '運用保守サポート',
        description:
  ...
  },
  {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        challenge:
          '採用・配置の判断が面接担当者の経験や紙の診断票に依存し、候補者と職種要件、チーム相性、入社後リスクを一貫して見られなかった。',
        solution:
          'HEXACO-100の心理尺度をシステム化し、LLMを構造化分析エンジンとして活用。個人レポート、採用ペルソナ適合、チーム相性分析まで支援するHR AIエージェントを構築した。',
        results: [
          '採用・配置の判断材料を可視化',
          '候補者・職種・チーム相性を一貫分析',
          '診断結果を業務で使えるレポートに変換',
    ...
    caseStudies: [
      {
        title: '心理学モデルを組み込んだHR AIエージェントの開発',
        challenge:
          '採用・配置の判断を、印象や紙の診断票ではなく、心理尺度とAI分析に基づく判断材料として整えられるかを先に確かめたかった。',
        solution:
          'HEXACO-100のスコアリングとLLMの構造化分析を組み合わせ、候補者レポート、採用ペルソナ適合、チーム相性分析まで実際に動く形で検証し、本開発に移行した。',
        results: [
          '採用・配置の判断材料を可視化',
          '候補者・職種・チーム相性を一貫分析',
          'PoCから本開発へスムーズに移行',
