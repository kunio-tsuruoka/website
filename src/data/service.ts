  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'もともとBeekle社内で回していた開発の進め方を、AIエージェントで動くようにした自社基盤です。新しく持ち込んだ手法ではなく、これまでの案件で使ってきたやり方をそのまま仕組みにしています。要求、要件、ユーザーストーリー、受入条件、実装タスク、確認結果を複製せず関係でつなぐので、仕様変更がどの確認観点とタスクへ効くかを追えます。要件定義を急いで固め切らなくても開発を進められるのはこのためです。外部提供は準備中で、社内では現在も使っています（pmonrails.com）。',
      },
      {
