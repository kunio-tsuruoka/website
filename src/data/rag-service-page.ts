...
export const ragService: ServiceDetail = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '検証・PoCは200万〜500万円、本番開発は800万〜2,000万円、継続運用は月20万〜100万円が目安です。PoCでも要件整理、データ設計、検索・回答基盤、評価、検証環境の構築に複数人月を要します。複数基盤や高い可用性、継続的なAI・PM体制が必要な運用は月120万円以上になる場合があります。対象データ、連携先、権限、必要な評価範囲を確認し、初回相談後に内訳付きで提示します。',
    },
    {
