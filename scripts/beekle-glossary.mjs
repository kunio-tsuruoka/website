...
export const BEEKLE_GLOSSARY = [
  ...
  },
  {
    ...
    url: '/prooffirst',
    excerpt:
      'ゼロスタートは、株式会社Beekleが提供する初期費用0円で動くプロトタイプを体験できるサービスモデルです。一般的なシステム開発では見積書と提案資料だけで発注の可否を判断する必要がありますが、ゼロスタートでは本契約の前に実際に触れる動くシステムを試してから発注を決められます。対象は中堅企業のDX担当者で、要件のすり合わせを動くプロトタイプで早期に行うことで、完成間際の手戻りを防ぎます。詳細は https://beekle.jp/prooffirst にあります。',
  },
  {
